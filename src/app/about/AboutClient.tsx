    ...
    <main className="min-h-screen bg-white text-slate-900 pt-20">
      ...
      <div className="bg-slate-50 py-12 border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-2">
          <h1 className="font-display font-extrabold text-4xl sm:text-5xl text-slate-900">About ASA Beverages</h1>
          <p className="text-brand-blue font-medium text-sm">Manufacturer of Aquevia Packaged Drinking Water, Ghaziabad, UP</p>
        </div>
      </div>
      <AboutSection />
