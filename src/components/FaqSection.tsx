...
export default function FaqSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Our flagship primary bottle size is 1L. We also manufacture 500ml travel bottles, 2L family cans, 5L pantry jugs, and 20L heavy-duty dispenser jars for offices and homes.",
    },
  ];
